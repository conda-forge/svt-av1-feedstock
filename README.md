...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/svt-av1-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/svt-av1-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `svt-av1` available on your platform:
...
```
pixi search svt-av1 --channel conda-forge
```
